...
<body>
  ...
  <div class="container mt-5">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <a href=" <?= base_url('kandidat/tambah'); ?> " class="btn btn-primary mr-5">tambah</a>
        <br>
        <br>
          ...
          <tbody>
            ...
            foreach ($kandidat as $dkandidat):
              ...
              <tr>
                ...
                <td>
                  <?php echo $dkandidat['nama_ketos'] ?>
                </td>
                <td>
                  <?php echo $dkandidat['nama_waketos'] ?>
                </td>
                <td>
                  <?php echo $dkandidat['image'] ?>
                </td>
                <td>
                  <?php echo $dkandidat['visi'] ?>
                </td>
                <td>
                  <?php echo $dkandidat['misi'] ?>
                </td>
